...
<body>
	...
	<div id="allpage">
		<div id="content">
			...
			<br>
			<br>
			<img width="750px" src="${pageContext.request.contextPath}/other/services/img/8-1.jpg"/><br>
			<br>
			<h1>${proc.name}</h1>
			...
			<br>
			<img width="750px" src="${pageContext.request.contextPath}/other/services/img/8-2.jpg"/><br>
			<br>
			<h2>淨膚雷射治療對象</h2>
			<br>
			<ol>
			...
			<img width="750px" src="${pageContext.request.contextPath}/other/services/img/8-3.jpg"/><br>
			<li>治療間隔：2~4週</li>
			<li>治療步驟：清潔臉部、開始治療〈一般人不需上麻藥，特別緊張怕痛的人可以上麻藥〉、冷敷〈或加上自體活細胞生長因子PRP效果更好〉</li>
			<img width="750px" src="${pageContext.request.contextPath}/other/services/img/8-6.jpg"/><br>
			</ol>
			<br>
			<h2>療效分析</h2>
			<br>
			...
			<img width="750px" src="${pageContext.request.contextPath}/other/services/img/8-4.jpg"/><br>
