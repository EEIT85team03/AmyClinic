            ...
            <div class="group">
                <div style="width: 48%; float: left;">
                    ...
                    <span class="wpcf7-form-control-wrap email-680">
                        <label>電子郵件:</label>
                        <input type="email" name="email-680" value="" size="45" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" placeholder="${memberVO.email}" >
                    </span>
                    <br>
                    <span class="wpcf7-form-control-wrap tel-630">
                        <label>連絡電話:</label>
                        <input type="tel" name="tel-630" value="" size="45" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel" aria-required="true" placeholder="${memberVO.phone}" >
                    </span>
                    <br>
                    <span class="wpcf7-form-control-wrap textarea-398">
                        <label>需求描述:</label>
                        <textarea name="descrip" placeholder="${param.descrip}" class="wpcf7-form-control wpcf7-textarea"></textarea>
                    </span>
