				...
				<div class="container">
					<div class="bolg-posts">
							<div class="col-md-12 blog-top">
								<div class="blog-in">
									<a href="single.jsp" class="blog-post"><img src="images/b1.jpg" alt=" "></a>
									<div class="blog-grid">
										<div class="date">
											<span class="date-in"><i class="fa fa-calendar"></i>29.3.2016</span>
											<a href="single.jsp" class="comments"><i class="fa fa-comment"></i>48</a>
											<div class="clearfix"> </div>
										</div>
										<h3><a href="single.jsp">Distribution of clinical laboratories in health</a></h3>
										...
										<a href="single.jsp" class="smore">READ MORE</a>										
									</div>
									<div class="clearfix"></div>					
								</div>
								<i class="black"> </i>
							...
							<div class="col-md-12 blog-top">
								<div class="blog-in blog-in1">
									<a href="single.jsp" class="blog-post1"><img src="images/b2.jpg" alt=" "></a>
									<div class="blog-grid">
										<div class="date">
											<span class="date-in"><i class="fa fa-calendar"></i>25.03.2016</span>
											<a href="single.jsp" class="comments"><i class="fa fa-comment"></i>42</a>
											<div class="clearfix"> </div>
										</div>
										<h3><a href="single.jsp">Cytopathology examines smears of cells from all over the body</a></h3>
							...
							<div class="col-md-12 blog-top">
								<div class="blog-in">
									<a href="single.jsp" class="blog-post"><img src="images/b3.jpg" alt=" "></a>
									<div class="blog-grid">
										<div class="date">
											<span class="date-in"><i class="fa fa-calendar"></i>19.3.2016</span>
											<a href="single.jsp" class="comments"><i class="fa fa-comment"></i>34</a>
											<div class="clearfix"> </div>
										</div>
										<h3><a href="single.jsp">Electron microscopy prepares specimens and takes micrographs</a></h3>
										<p>Photography Daniel Jackson,  styling by Alastair McKimm, hair by Shon  and Esther Langham, make-up by Yadim,  Francelle and Hannah Murray, <span>
										casting by AM casting. Production  by Nikki Stromberg and Matthew Youmans at M.A.P New York.</span></p>
										<a href="single.jsp" class="smore">READ MORE</a>										
									</div>
							...
							<div class="col-md-12 blog-top">
								<div class="blog-in blog-in1">
									<a href="single.jsp" class="blog-post1"><img src="images/b4.jpg" alt=" "></a>
									<div class="blog-grid">
										<div class="date">
											<span class="date-in"><i class="fa fa-calendar"></i>25.03.2016</span>
											<a href="single.jsp" class="comments"><i class="fa fa-comment"></i>42</a>
